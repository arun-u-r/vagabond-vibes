...
const HeroBlock = () => {
    return (
        <div className="w-full h-[90vh] ">
            <img src={`${import.meta.env.BASE_URL}wp13100987-vagabond-pc-wallpapers.png`} alt="v-v-favicon-black.svg"
                className="w-full h-full object-cover"
            />
            <div className="max-w-[1140px] m-auto">
                <div className="absolute top-[10%] w-full md:-[50%] max-w-[500px] h-full flex flex-col text-white p-4 ">
                    <img src={`${import.meta.env.BASE_URL}v-v-logo-white.svg`} alt="" className=" ml-10 p-2 w-[9rem] h-[9rem] object-cover " />
