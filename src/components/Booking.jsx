            ...
            <div id="deals" className="max-w-[1140px] m-auto w-full p-4 ">
                <form className="lg:flex lg:justify-between w-full items-center p-2 gap-4" >
                    <div className="flex flex-col my-2 p-2 lg:max-w-[250px]">
                        ...
                        <select className="lg:w-[-300px] p-1 rounded-md hover:scale-105">
                    ...
                    <div className="flex flex-col lg:flex-row w-full">
                        <div className="flex flex-col w-full lg:max-w-[250px] my-2 p-2">
                            ...
                            <input type="datetime-local" name="check-in" id="check-in"
                                className="border rounded-md pl-2 hover:scale-105" />
                        </div>
                    ...
                    <div className="flex flex-col my-2 p-2 w-full items-center"
                        ...
                        <button
                            className="hover:scale-105 mt-2 cursor-pointer text-white font-bold relative text-[14px] w-full h-[3em] 
